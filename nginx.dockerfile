...
#or ng build --watch --delete-output-path false
...
#Learn about mac and linux path here on this blog
...
# on windows:docker run -p 8080:80 -v ${PWD}/dist:/usr/share/nginx/html nginx-angular
